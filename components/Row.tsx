...
function Row( { title, movies }: Props ) {
    ...
    /* Carrousel Function basicamente adiciona ou diminui o valor do tamanho da tela do usuário do
       scroll, com base no click no botão de mover para a direita ou para a esquerda.
    */
